...
using tieuluan_ban_giay.Others;
...
namespace tieuluan_ban_giay.Controllers
{
    public class ThanhToanController : Controller
    {
        ...
        public ActionResult Payment()
        {
            ...
            pay.AddRequestData("vnp_Amount", gh.LayTongTien().ToString() + "00"); //số tiền cần thanh toán, công thức: số tiền * 100 - ví dụ 10.000 (mười nghìn đồng) --> 1000000
